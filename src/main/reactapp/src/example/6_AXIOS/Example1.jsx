...
export default function Example1(props) {
    ...
    const onEvent3 = async ( ) => {
        ...
        console.log('==========================[3 GET]==========================');
        const response3 = await axios.get('https://jsonplaceholder.typicode.com/comments?posptId=1'); // 매개변수 보내기 : query string 방식
    ...
    const onEvent5 = async ( ) => {
        ...
        const response1 = await axios.put('https://jsonplaceholder.typicode.com/posts/1' , obj); // 매개변수 보내기 : body(JSON) 방식
        console.log(response1.data);
    }
