...
let count = 0;
count = 1; // 변수값 수정
const count2 = 1; // 상수 선언
// const2 = 1; // 상수값 수정 // 오류 : Assignment to constant variable.
...
function fun1(param1, param2) { }
    // 정의2 : 익명 함수 , 주로 변수/상수 저장해서 사용한다.
const fun2 = function ( param1 , param2 ) { }
    // 정의3 : 화살표/람다식 함수 , 주로 변수/상수 저장해서 사용한다.
...
const obj3 = { name3, age3 }; // vs { name3 : name3 , age3 : age3 }
    // 3. 객체의 속성값 호출 , .(접근연산자)
console.log(obj3.name3, obj3.age3);
...
// [8] 단축 연산/평가
    ...
    // 조건(A) || 거짓(B) : 만약에 조건이 true 이면 A반환
console.log( loginState && '로그인상태' );
const loginState2 = false;
console.log( loginState2 && '로그인상태' );
console.log( loginState || '비로그인상태' );
console.log( loginState2 || '비로그인상태' );
