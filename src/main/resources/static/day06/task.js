...
const multifly = (num1, num2) => num1 * num2;
console.log(multifly(3, 4));

// 3. name과 age를 활용해서 "저는 [이름]이고, [나이]살입니다." 를 출력하세요.
console.log(`저는 ${name2} 이고, ${age} 살입니다.`);
...
const 성인 = ages.filter ( (age, index) => { return age >= 20; } )
const 미성년자 = ages.filter ( (age, index) => { return age < 20; } )
console.log(성인);
console.log(미성년자);
